<template>
  <div class="app-container calendar-list-container">
    <div class="filter-container">
      <el-button-group>
        <el-button type="primary" v-if="groupManager_btn_add" icon="plus" @click="handlerAddChild">添加子节点</el-button>
        <el-button type="primary" v-if="groupManager_btn_edit" icon="edit" @click="handlerEdit">编辑</el-button>
        <el-button type="primary" v-if="groupManager_btn_del" icon="delete" @click="handleDelete">删除节点</el-button>
      </el-button-group>
    </div>
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      this.groupManager_btn_add = elements['groupManager:btn_add'] | this.role =='admin';
      this.groupManager_btn_edit = elements['groupManager:btn_edit'] | this.role =='admin';
      this.groupManager_btn_del = elements['groupManager:btn_del'] | this.role =='admin';
    },
    computed: {
      ...mapGetters([
        'menus',
